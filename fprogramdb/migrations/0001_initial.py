# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-19 09:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fprogramdb.EuodpData')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='call',
            name='source',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fprogramdb.EuodpData'),
        ),
    ]
