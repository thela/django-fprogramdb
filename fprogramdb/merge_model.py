...
def get_all_related_objects(alias_object):
    # return alias_object._meta.get_all_related_objects()

    _res_new = []
    for field in alias_object._meta.get_fields():
        if isinstance(field, models.ManyToOneRel) or isinstance(field, models.OneToOneRel):
            _res_new.append(field)
    return _res_new


def get_all_related_many_to_many_objects(alias_object):
    # return alias_object._meta.get_all_related_many_to_many_objects()
